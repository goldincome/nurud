        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-8 text-sm text-white/60 mb-10">
            ...
            <div class="col-span-2 md:col-span-1">
                <a href="/" class="block mb-4">
                    <img src="{{ asset('images/nurud-logo.png') }}" alt="Nurud Travels" class="h-10 w-auto"
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('terms') }}" class="hover:text-white transition-colors">Terms & Conditions</a>
                    </li>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li class="flex items-start gap-2"><i
                            class="fas fa-map-marker-alt mt-0.5 text-brand-red text-xs"></i> Unit 6, Block 3 Woolwich,
                        Dockyard Industrial Estate, Woolwich Church St, Charlton, London SE18 5PQ</li>
                    <li class="flex items-start gap-2"><i class="fas fa-phone mt-0.5 text-brand-red text-xs"></i> +44
                        (0) 2032474747</li>
                    <li class="flex items-start gap-2"><i class="fas fa-envelope mt-0.5 text-brand-red text-xs"></i>
                        info@nurud.com</li>
                </ul>
            </div>
        </div>
