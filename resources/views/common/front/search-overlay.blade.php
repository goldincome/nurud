    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 transform transition-all duration-300 scale-95 opacity-0"
            ...
            <div class="text-center">
                <div class="mb-4">
                    <div class="relative">
                        <div class="w-16 h-16 border-4 border-gray-200 rounded-full mx-auto animate-spin">
                            <div class="w-full h-full border-4 border-brand-blue rounded-full border-t-transparent">
                            </div>
                        </div>
                ...
                <p class="text-gray-600 text-sm mb-6" id="overlay-subtitle">We're comparing prices across multiple
                    airlines to find you the best deal</p>
