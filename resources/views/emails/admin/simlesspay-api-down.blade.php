...
<body>
    <div class="container">
        <div class="header">
            <h1>⚠️ SimlessPay API is DOWN</h1>
        </div>
        <div class="body">
            <div class="alert-box">
                <strong>Service Disruption:</strong> The SimlessPay payment API is currently unreachable. Currency conversion and payment processing may be affected.
            </div>
            ...
            <p style="margin-top: 20px; font-size: 13px; color: #64748b;">
                ...
                1. Check the SimlessPay API status<br>
                2. Verify API credentials are still valid<br>
                3. Contact SimlessPay support if the issue persists<br>
                4. Monitor currency conversion failures
            </p>
