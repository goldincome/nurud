                ...
                <form action="{{ route('bookings.checkout') }}" method="POST">
                                ...
                                <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
                                    ...
                                    <div class="flex-1 px-8 flex flex-col items-center">
                                        ...
                                        @if(isset($itinerary['segments'][0]['cabin']))
                                            ...
                                            $itinerary['segments'][0]['cabin'] }} ({{ $itinerary['segments'][0]['class'] }})</span>
                                        @endif
                                    </div>
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mt-4 gap-4">
                        <p class="text-xs text-slate-500">
                            By clicking continue, you are agreeing to the <a href="#"
                                class="text-brand-blue underline">terms &
                                conditions</a>
                        </p>
                        <button
                        ...
                        <div class="mb-2">
                            ...
                            @if(isset($flightData['verifiedPriceBreakdown']['taxesAndFees']))
                                <div class="flex justify-between text-xs text-slate-600 mb-2">
                                    ...
                                    <span
                                        class="font-medium">₦{{ number_format($flightData['verifiedPriceBreakdown']['taxesAndFees'], 2) }}</span>
                                </div>
                            @endif
                            <div class="flex justify-between text-xs text-slate-600 mb-2">
                                <span>Discount</span>
