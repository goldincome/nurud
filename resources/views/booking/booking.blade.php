        ...
        <div class="container mx-auto px-4 max-w-4xl">
            <div class="relative flex items-center justify-between w-full">
                ...
                <div class="relative z-10 flex flex-col items-center step-active">
                    ...
                    <span class="text-xs text-white font-bold">Traveler Details</span>
                </div>
                ...
                <form action="{{ route('bookings.checkout') }}" method="POST">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mt-4 gap-4">
                        <p class="text-xs text-slate-500">
                            By clicking continue, you are agreeing to the <a href="{{ route('terms') }}"
                                class="text-brand-blue underline" target="_blank">terms &
                                conditions</a>
                        </p>
                        <button
