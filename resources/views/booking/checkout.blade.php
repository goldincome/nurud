    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div id="payment-content"
                ...
                <div id="tab-transfer" class="animate-fade-in block">
                ...
                <div id="tab-card" class="hidden animate-fade-in">
                    <div class="bg-brand-blue px-6 py-4">
                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-slate-50 border border-slate-200 rounded-lg p-5 mb-6">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <h3 class="font-bold text-slate-800">Pay securely with your card via Paystack</h3>
                            </div>
                            <p class="text-xs text-slate-500 ml-5">Mastercard, Visa, and Verve accepted.</p>
                        </div>
                        ...
                        <div class="flex justify-end">
                            <button
                                class="bg-brand-orange hover:bg-brand-orangeHover text-white font-bold py-3 px-8 rounded-full shadow-md transition-colors">
                                Pay with Card
                            </button>
                        </div>
                    </div>
                ...
                <div id="tab-hold" class="hidden animate-fade-in">
                    ...
                    <div class="p-6 text-center py-12">
                        ...
                        <h3 class="text-xl font-bold text-slate-800 mb-2">Hold your booking for 24 hours</h3>
                        <p class="text-sm text-slate-600 max-w-md mx-auto mb-8">
                            ...
                            payment is not received within 24 hours. We accept payments by bank transfer or cash
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex justify-between mt-2">
                            ...
                            <div class="text-right">
                                @if(isset($itinerary['segments'][count($itinerary['segments']) -
                                1]['segmentArrival']['at']))
                                @php
